export const translations = {
	ES: {
		...
		page_projects_technology: "Tecnologias",
		page_projects_online: "En Linea",
		page_projects_code: "Codigo",
		page_projects_more_information: "Mas informacion...",
		...
		page_projects_n1_img: "assets/svg/-learning.svg",
		page_projects_n1_code: "https://github.com/jjmirandaa86/learningwords",
		page_projects_n1_more_information:
			"https://github.com/jjmirandaa86/learningwords/blob/main/README.md",
		page_projects_n1_technology: [
			{ id: 1, name: "React", img: "assets/svg/react-native.svg" },
			{ id: 1, name: "NextJS", img: "assets/svg/next-js.svg" },
			{ id: 1, name: "Redux", img: "assets/svg/redux.svg" },
			{ id: 1, name: "Bootstrap", img: "assets/svg/bootstrap.svg" },
		],
		...
		page_projects_n2_img: "assets/svg/-business.svg",
		page_projects_n2_code: "",
		page_projects_n2_more_information: "",
		page_projects_n2_technology: [
			{ id: 1, name: "React", img: "assets/svg/react-native.svg" },
			{ id: 1, name: "NextJS", img: "assets/svg/next-js.svg" },
			{ id: 1, name: "Redux", img: "assets/svg/redux.svg" },
			{ id: 1, name: "Bootstrap", img: "assets/svg/bootstrap.svg" },
	...
	EN: {
		...
		page_projects_technology: "Technology",
		page_projects_online: "Online",
		page_projects_code: "Code",
		page_projects_more_information: "More information...",
